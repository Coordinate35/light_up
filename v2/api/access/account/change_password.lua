...
local check_item = form_check_config.change_password
...
local result = s_account:is_password_changeable(args.phone_number)
if false == result then
	local msg = zh_lang.change_password_not_allowed
